 ...
 */
#define SLURM_VERSION_NUMBER 0x110209
...
typedef struct job_descriptor {	/* For submit, allocate, and update requests */
	...
	uint32_t pack_leader;	/* job_id of pack_leader for job_pack or 0 */
	...
	uint8_t resv_port;      /* jobpack resv-port for nodes flag */
 ...
 * uin32_t and only 12 bits are used for the signal. These flags are << 24
